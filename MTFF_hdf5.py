...
class Rational(tk.Tk):
    def __init__(self, *args,
        ...
        filemenu.add_command(label="save setting",
...
def main():
    ...
    %Y is the all year
    %r is for all data readable

    collection = []
    dateTimeString = datetime.today() # or str(datetime.today())
    collection.append(dateTimeString, sort=False)
    print(collection)
    ...
    # 27.02.2019 Ende Running machine learning'''
